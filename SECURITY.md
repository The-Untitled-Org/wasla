...
The maintainers will acknowledge the report, investigate it, and coordinate remediation before public
disclosure. Response and release timing depends on the severity and complexity of the issue.
