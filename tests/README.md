...
This directory contains all tests for the Wasla project, organized by test type.
...
- **e2e-workflow.test.ts** — Tests complete Wasla workflows:
...
- **Test Data:** Use realistic data that mirrors actual Wasla usage
